...
## Environments
- Preview: https://main--adapt--jckautzmann.aem.page/
- Live: https://main--adapt--jckautzmann.aem.live/
...
1. Open the `adapt` directory in your favorite IDE and start coding :)
